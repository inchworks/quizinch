...
A user manual is available. It assumes a Raspberry Pi is used and includes a hardware checklist, quiz setup, and fallback suggestions. It also has instruction sheets for the controller, quizmaster and scorers. See docs/manuals in the Codeberg repository.
